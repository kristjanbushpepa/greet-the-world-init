...
export const ImageCarousel = ({ mobileImages, desktopImages }: ImageCarouselProps) => {
        ...
        <Carousel className="w-full max-w-5xl mx-auto">
          <CarouselContent>
            {currentImages.map((image, index) => (
              <CarouselItem key={`${viewMode}-${index}`} className="md:basis-1/2 lg:basis-1/3">
                <Card className="bg-white/70 backdrop-blur-md border border-blue-100 hover:bg-white/90 transition-all duration-300 group hover:scale-105 hover:shadow-xl">
                  <CardContent className="p-6">
                    <div 
                      className="aspect-video bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg overflow-hidden mb-4 border-2 border-blue-100 cursor-pointer"
